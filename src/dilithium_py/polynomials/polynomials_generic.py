...
class Polynomial:
    ...
    # CHATGPT ADDED
    def apply_to_coeffs(self, func):
        """
        Apply a function to each coefficient of the polynomial.
        :param func: A function to apply to each coefficient.
        :return: A new Polynomial with updated coefficients.
        """
        new_coeffs = [func(c) for c in self.coeffs]
